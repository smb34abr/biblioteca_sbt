  ...
  <div class="m-header flex items-center py-4 px-6 h-header-height">
    ...
    <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="libros.php" class="pc-link">
            <span class="pc-micon">
              <i data-feather="book"></i>
            </span>
            <span class="pc-mtext">Libros</span>
          </a>
        </li>

        <li class="pc-item">
          <a href="escritores.php" class="pc-link">
            <span class="pc-micon">
              <i data-feather="edit"></i>
            </span>
            <span class="pc-mtext">Escritores</span>
          </a>
        </li>

        <li class="pc-item">
          <a href="editoriales.php" class="pc-link">
            <span class="pc-micon">
              <i data-feather="layers"></i>
            </span>
            <span class="pc-mtext">Editoriales</span>
          </a>
        </li>
